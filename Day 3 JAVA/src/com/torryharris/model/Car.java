...
public class Car {
    ...
    public void displayFeatures(){
        ...
        System.out.println("Music System Name:"+ getMusicSystem().getMsName()+"  No of Speakers:"+getMusicSystem().getNoOfSpeakers()+" LCD ScreenSize:"+getMusicSystem().getLcdScreenSize());
    }
}
